...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-indigo-50/50 py-1 pr-3 pl-1.5 text-sm text-indigo-900 ring-1 ring-indigo-500/20 ring-inset dark:bg-indigo-500/5 dark:text-indigo-200 dark:ring-indigo-500/30">
